...
export const cardSearch = new CommandBuilder('Reaction.CardSearch_Small')
    ...
    .withHelp(
        (botUsername) =>
            ...
            'Для цього використовуйте наступний синтаксис: *\\[_назва картки_\\]* або *\\[_запит у синтаксисі Scryfall_\\]*\\. Також після назви картки, через символ _\\#_ можна задати додаткові флаги для отримання дотаткових даних, кожен флаг повинен починатися з \\#\n\n' +
            'Також доступні наступні флаги:\n' +
            ...
            ' \\- _random_ \\- покаже випадкову картку\n\n' +
            ...
            'Флаги також працюють у цьому режимі, але синтаксис трохи інший: флаги потрібно вказати до назви картки\\. Наприклад:\n' +
