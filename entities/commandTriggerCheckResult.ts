export default class CommandTriggerCheckResult {
    static get DontTriggerAndSkipCooldown() { return new CommandTriggerCheckResult(false, null, true); }
    static get DoNotTrigger() { return new CommandTriggerCheckResult(false, null, false) };

    shouldTrigger: boolean;
    matchResult: RegExpExecArray | null;
    skipCooldown: boolean;

    constructor(shouldTrigger: boolean, matchResult: RegExpExecArray | null, skipCooldown: boolean) {
