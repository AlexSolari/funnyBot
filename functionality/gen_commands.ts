...
export default [banner,black,cardSearch_small,control,dispute,fang,hello,ihor,kalitas,kamaz,lotus,pizda,ponyav,potuzhno,potuzhnoStats,rakdos,rating,registration,ring,rozklad,slon,spamlol,ternopil,test,vitalii].filter(x => x.active);
